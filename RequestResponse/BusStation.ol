...
init
{
	println@Console( "Bus station started" )()
}

main
{
	buyTicket( request )( response ) {
		println@Console( "Ticket bought for bus number " + request.busNumber + ", from " + request.from + " to " + request.to )()
	}
}