...
import java.util.logging.*; // For benchmarking.
...
public final class AmqpCommChannel extends StreamingCommChannel {
  ...
  // For benchmarking.
  private static final Logger log = Logger.getLogger("jolie.net.amqp");
  ...
  protected CommMessage recvImpl() throws IOException {
    log.info(String.format("recvImpl - Called:%s", System.nanoTime())); // For benchmarking.
  ...
  protected void sendImpl(CommMessage message) throws IOException {
    log.info(String.format("sendImpl - Called:%s", System.nanoTime())); // For benchmarking.
    ...
    log.info(String.format("sendImpl - Returned succesfully:%s", System.nanoTime()));
  }
